  ...
  return (
    <div
      style={{
        padding: "9px 10px",
        borderRadius: 12,
        background: "linear-gradient(160deg, #FFF8F2 0%, #F0EDE6 100%)",
      ...
      >
        <span
          style={{
            ...
            height: 20,
            borderRadius: "50%",
            background: atMax ? "#E8E4DC" : "#fb923c",
            color: "white",
            display: "flex",
            alignItems: "center",
            justifyContent: "center",
...
export default function ProfilePage({ currentUser, onProfileUpdate }) {
  ...
  const [industry, setIndustry] = useState(currentUser?.industry ?? "");  const [city, setCity] = useState(currentUser?.location ?? "");
  ...
  return (
    <div className="profile-page flex flex-col w-full h-dvh bg-[#F0EDE6] overflow-hidden">
      ...
      {!isComplete && (
        <p
          className="flex-shrink-0 mx-4 mb-1.5 px-2.5 py-1 rounded-lg text-center"
          style={{
            fontSize: 11,
            fontWeight: 500,
            color: "#C4785A",
          ...
          <div className="flex flex-col gap-1.5">
            <div>
              ...
              <input
                ...
                style={inputStyle(hasError && !displayName.trim())}
              />
            </div>
            ...
            <div>
              ...
              <input
                value={industry}
                onChange={(e) => { setIndustry(e.target.value); clearStatus(); }}
                onFocus={preventFocusJump}
                placeholder="e.g. Software Engineering"
                style={inputStyle(hasError && !industry.trim())}
              />
            </div>
            ...
            <div>
              ...
              <input
                ...
                style={inputStyle(hasError && !city.trim())}
              />
            </div>
            ...
            <div>
              ...
              <input
                type="text"
                value={bio}
                onChange={(e) => { setBio(e.target.value); clearStatus(); }}
                onFocus={preventFocusJump}
